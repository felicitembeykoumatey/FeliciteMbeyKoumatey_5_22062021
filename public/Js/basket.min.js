...
fetch(`http://localhost:3000/api/furniture`)
  ...
  .then(function (item) {
    (productName.textContent = item.name),
      (quantityElt.textContent = quantityElt.value);
    (priceElt.textContent = item.price / 100 + " €"),
      (totalPriceElt.textContent = item.price / 100 + " €");
    ...
    if (basket === null) {
      ...
      <div> quantité ${basket.quantityElt}</div>
