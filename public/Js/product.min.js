  ...
  console.log("addToBasket:" + addToBasket),
    addToBasket.addEventListener("click", () => {
      if (
        ...
        console.log(" arrayProductsInBasket:" + arrayProductsInBasket);
        // Si le localStorage existe, on récupère son contenu, on l'insère dans le tableau arrayProductsInBasket, puis on le renvoit vers le localStorage avec le nouveau produit ajouté.
