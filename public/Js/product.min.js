...
function errorIf404() {
  window.addEventListener("error", (e) => {
    let messageError = document.getElementById("container");
    messageError.innerHTML = `<p> Cette page n'existe pas.
     <a id="back-to-home" href="index.html"> Retourner dans la boutique ?</a></p>`;
    let backToHomeLink = document.getElementById("back-to-home");
  });
  console.log("errorIf404:" + errorIf404);
}
    ...
    addToBasket.addEventListener("click", () => {
      if (
        ...
        null !== localStorage.getItem("products") &&
          (arrayProductsInBasket = JSON.parse(
            localStorage.getItem("products")
          )),
          arrayProductsInBasket.push(productAdded),
          localStorage.setItem(
            "products",
            JSON.stringify(arrayProductsInBasket)
          );
      }
    });
}
